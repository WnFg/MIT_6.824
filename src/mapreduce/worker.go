...
func (wk *Worker) DoTask(arg *DoTaskArgs, _ *struct{}) error {
	//fmt.Printf("debug ttttttttttttttttt: %d %s\n", arg.Debug, arg.File)
	fmt.Printf("%s: given %v task #%d on file %s (nios: %d) (debug: %d)\n",
		wk.name, arg.Phase, arg.TaskNumber, arg.File, arg.NumOtherPhase, arg.Debug)
	...
	fmt.Printf("%s: %v task #%d done (debug: %d)\n", wk.name, arg.Phase, arg.TaskNumber, arg.Debug)
	return nil
}
